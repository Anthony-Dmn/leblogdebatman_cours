...
class BlogController extends AbstractController
{
    ...
    public function publicationView(Article $article, Request $request, ManagerRegistry $doctrine): Response
    {
        ...
        // On fait ça pour éviter que le traitement du formulaire ne se fasse alors que la personne n'est pas connectée
        if(!$this->getUser()){
    ...
    public function search(ManagerRegistry $doctrine, Request $request, PaginatorInterface $paginator): Response
    {
        ...
        // Création d'une requête qui récupérera seulement les articles dont le titre ou le contenu contient le mot recherché par l'utilisateur avec LIKE
        $query = $em
